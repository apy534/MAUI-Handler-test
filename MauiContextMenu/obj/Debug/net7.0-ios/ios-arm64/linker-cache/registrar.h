...
@class AppDelegate;
@class MauiContextMenu_Platforms_iOS_Handler_ContextMenuiOS;
...
@class MauiContextMenu_Platforms_iOS_CustomRenderers_ContextMenuViewRenderer;
...
@interface MauiContextMenu_Platforms_iOS_Handler_ContextMenuiOS : UIView {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
	...
	-(BOOL) canPerformAction:(SEL)p0 withSender:(NSObject *)p1;
	-(void) Properties:(UIMenuController *)p0;
	-(void) custom_action0:(UIMenuController *)p0;
	-(void) custom_action1:(UIMenuController *)p0;
	-(void) custom_action2:(UIMenuController *)p0;
	-(void) custom_action3:(UIMenuController *)p0;
	-(void) cut:(NSObject *)p0;
	-(void) copy:(NSObject *)p0;
	-(void) delete:(NSObject *)p0;
	-(BOOL) conformsToProtocol:(void *)p0;
@end
...
@interface MauiContextMenu_Platforms_iOS_CustomRenderers_ContextMenuViewRenderer : Microsoft_Maui_Controls_Handlers_Compatibility_ViewRenderer_2 {
}
	-(BOOL) canBecomeFirstResponder;
	-(BOOL) canPerformAction:(SEL)p0 withSender:(NSObject *)p1;
	-(void) Properties:(UIMenuController *)p0;
